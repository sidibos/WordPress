...
// Assanka change: disable this particular error handler...
...
// Assanka change: ...and replace with the normal one
require_once($_SERVER["CORE_PATH"]."/web/common/v1/Common");
require_once($_SERVER["CORE_PATH"]."/helpers/errorhandler/v5/errorhandler");
ErrorHandlerV5::removeActionTrigger('all', E_STRICT);
ErrorHandlerV5::removeActionTrigger('all', E_DEPRECATED);
// Assanka change end
