...
function GetUrlParam( paramName )
{
	...
	var oMatch = oRegex.exec( decodeURIComponent(window.top.location.search) ) ;
...
{
	var sUrl = '<?=$_SERVER["CORE_WEB_ALIAS"]?>/fckeditor/v2.5/editor/filemanager/browser/mcpuk/'+this.ConnectorUrl + '?Command=' + command ;
	sUrl += '&Type=' + this.ResourceType ;
	sUrl += '&ExtraParams=' + this.ExtraParams ;
	sUrl += '&CurrentFolder=' + encodeURIComponent( this.CurrentFolder ).replace("'", "%27") ;
