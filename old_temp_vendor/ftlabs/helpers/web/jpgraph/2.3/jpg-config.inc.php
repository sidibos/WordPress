...
// Created: 	2004-03-27
// Ver:		$Id: jpg-config.inc.php,v 1.2 2009-08-13 14:31:19 andrew Exp $
//
...
//
//------------------------------------------------------------------------
if (isset($_SERVER["DOCUMENT_ROOT"]) and is_dir($_SERVER["DOCUMENT_ROOT"]."/lib/tmp/")) {
	DEFINE("CACHE_DIR",$_SERVER["DOCUMENT_ROOT"]."/lib/tmp/");
} else {
...
if(!isset($_SERVER["CORE_PATH"])) trigger_error("Required constant CORE_PATH not defined in the environment", 
E_USER_ERROR);
if (file_exists($_SERVER["CORE_PATH"]."/web/admin/v3/fonts/")) {
        DEFINE("TTF_DIR",$_SERVER["CORE_PATH"]."/web/admin/v3/fonts/");
} else {
        DEFINE("TTF_DIR",$_SERVER["CORE_PATH"]."web/admin/v1/fonts/");
}
