...
A RESTful API for WordPress modified for FT Help purposes to expose pages like T&Cs, Cookie & Privacy policy, etc via a JSON API. Original documentation below:
