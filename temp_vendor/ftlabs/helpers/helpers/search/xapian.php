...
class XapianDocument {
	...
	function get_data() {
		...
		// Assanka change: Implement backoff, to avoid Helpdesk #25822
		$attempts = 0;
		while ($attempts < 5) {
			try {
...
class XapianStringListSerialiser {
	public $_cPtr=null;

	function __construct($initial=null) {
		switch (func_num_args()) {
		case 0: $r=new_StringListSerialiser(); break;
		default: $r=new_StringListSerialiser($initial);
		}
		$this->_cPtr=$r;
	}

	function append($value) {
		StringListSerialiser_append($this->_cPtr,$value);
	}

	function get() {
		return StringListSerialiser_get($this->_cPtr);
	}
}

class XapianStringListUnserialiser {
	public $_cPtr=null;

	function __construct($in_or_other=null) {
		switch (func_num_args()) {
		case 0: $r=new_StringListUnserialiser(); break;
		default: $r=new_StringListUnserialiser($in_or_other);
		}
		$this->_cPtr=$r;
	}

	function __ref__() {
		return StringListUnserialiser___ref__($this->_cPtr);
	}

	function get() {
		return StringListUnserialiser_get($this->_cPtr);
	}

	function next() {
		StringListUnserialiser_next($this->_cPtr);
	}

	function equals($other) {
		return StringListUnserialiser_equals($this->_cPtr,$other);
	}
}
...
class XapianMultiValueCountMatchSpy extends XapianValueCountMatchSpy {
	public $_cPtr=null;

	function __construct($slot_=null) {
		if (is_resource($slot_) && get_resource_type($slot_) == "_p_Xapian__MultiValueCountMatchSpy") {
			$this->_cPtr=$slot_;
			return;
		}
		switch (func_num_args()) {
		case 0: $r=new_MultiValueCountMatchSpy(); break;
		default: $r=new_MultiValueCountMatchSpy($slot_);
		}
		$this->_cPtr=$r;
	}

	function apply($doc,$wt) {
		MultiValueCountMatchSpy_apply($this->_cPtr,$doc,$wt);
	}

	function clone_object() {
		$r=MultiValueCountMatchSpy_clone_object($this->_cPtr);
		return is_resource($r) ? new XapianMatchSpy($r) : $r;
	}

	function name() {
		return MultiValueCountMatchSpy_name($this->_cPtr);
	}

	function serialise() {
		return MultiValueCountMatchSpy_serialise($this->_cPtr);
	}

	function unserialise($s,$context) {
		$r=MultiValueCountMatchSpy_unserialise($this->_cPtr,$s,$context);
		return is_resource($r) ? new XapianMatchSpy($r) : $r;
	}

	function get_description() {
		return MultiValueCountMatchSpy_get_description($this->_cPtr);
	}
}

class XapianMultiValueSumMatchSpy extends XapianValueCountMatchSpy {
	public $_cPtr=null;

	function __construct($slot_=null) {
		if (is_resource($slot_) && get_resource_type($slot_) == "_p_Xapian__MultiValueSumMatchSpy") {
			$this->_cPtr=$slot_;
			return;
		}
		switch (func_num_args()) {
		case 0: $r=new_MultiValueSumMatchSpy(); break;
		default: $r=new_MultiValueSumMatchSpy($slot_);
		}
		$this->_cPtr=$r;
	}

	function apply($doc,$wt) {
		MultiValueSumMatchSpy_apply($this->_cPtr,$doc,$wt);
	}

	function clone_object() {
		$r=MultiValueSumMatchSpy_clone_object($this->_cPtr);
		return is_resource($r) ? new XapianMatchSpy($r) : $r;
	}

	function name() {
		return MultiValueSumMatchSpy_name($this->_cPtr);
	}

	function serialise() {
		return MultiValueSumMatchSpy_serialise($this->_cPtr);
	}

	function unserialise($s,$context) {
		$r=MultiValueSumMatchSpy_unserialise($this->_cPtr,$s,$context);
		return is_resource($r) ? new XapianMatchSpy($r) : $r;
	}

	function get_description() {
		return MultiValueSumMatchSpy_get_description($this->_cPtr);
	}
}

class XapianNumericRange {
	public $_cPtr=null;

	function __construct($lower_,$upper_) {
		$this->_cPtr=new_NumericRange($lower_,$upper_);
	}

	function get_lower() {
		return NumericRange_get_lower($this->_cPtr);
	}

	function get_upper() {
		return NumericRange_get_upper($this->_cPtr);
	}
}

class XapianNumericRanges {
	public $_cPtr=null;

	function __construct() {
		$this->_cPtr=new_NumericRanges();
	}

	function get_values_seen() {
		return NumericRanges_get_values_seen($this->_cPtr);
	}

	function get_ranges() {
		return NumericRanges_get_ranges($this->_cPtr);
	}
}

class XapianUnbiasedNumericRanges extends XapianNumericRanges {
	public $_cPtr=null;

	function __construct($spy,$max_ranges) {
		$this->_cPtr=new_UnbiasedNumericRanges($spy,$max_ranges);
	}
}
