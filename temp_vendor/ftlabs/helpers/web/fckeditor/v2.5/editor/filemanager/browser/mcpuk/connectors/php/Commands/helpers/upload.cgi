...
## Assanka start ##########################################################
#require("./header.cgi");
## Manually include header as loadcore seems to break relative cgi linking
$tmp_dir=$ENV{'DOCUMENT_ROOT'}."../lib/tmp";
$|=1;								#unbuffers streams
