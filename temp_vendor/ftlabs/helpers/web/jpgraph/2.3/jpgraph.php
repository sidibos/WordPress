...
// Created: 	2001-01-08
// Ver:		$Id: jpgraph.php,v 1.3 2010-01-03 15:30:49 andrew Exp $
//
 ...
 */
trigger_error('Deprecated code in use: ' . __FILE__, E_USER_NOTICE);
...
class RGB {
	...
	$this->rgb_table = array(
	    ...
	    "iomagold1"=>array(186, 159, 103),
	    "iomagold2"=>array(245, 241, 230),
		);
    }
//----------------
// PUBLIC METHODS
...
class Image {
	...
	*/
	...
	if( $dir==90 ) {
		...
		// Assanka change: prevent E_DEPRECATED errors
		// was: if( ereg("\n",$txt) ) {
		if (strpos($txt, "\n") !== false) {
		// End Assanka change
