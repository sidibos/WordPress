/**
 * $Id: editor_plugin_src.js,v 1.2 2008-08-20 00:22:53 andrew Exp $
 *
 * @author Moxiecode
			...
			ed.addCommand('mcePasteWord', function(ui, v) {
				if (ui) {
					if ((ed.getParam('paste_use_dialog', true)) || (!tinymce.isIE)) {
						...
						// Assanka change: This was InsertText, which I think is incorrect
						t._insertWordContent(t._clipboardHTML());
				} else
