...
tinymce.create('tinymce.ui.Toolbar:tinymce.ui.Container', {
	renderHTML : function() {
		...
		for (i=0; i<cl.length; i++) {
			...
			// Assanka change: Allow use of TinyMCE in altered document.domain environment
			var domainparts = document.domain.split("."); if (typeof tmceDomainOverride != 'undefined') tinymce.relaxedDomain = domainparts[domainparts.length-2]+"."+domainparts[domainparts.length-1];
