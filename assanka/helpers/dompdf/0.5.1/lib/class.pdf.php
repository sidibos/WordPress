...
class  Cpdf {
    ...
    if  (!isset($this->fonts[$fontName])) {
      ...
      if  (isset($this->fonts[$fontName])) {
        ...
        if  (substr($fontName, -4) ==  '.afm' &&  strlen($fbtype)) {
		  ...
		  // Assanka change: prevent E_DEPRECATED error
          // removed: set_magic_quotes_runtime(0);
          // End Assanka change

          $data =  file_get_contents($fbfile);

		  // Assanka change: prevent E_DEPRECATED error
          // removed: set_magic_quotes_runtime($tmp);
          // End Assanka change
  ...
  function  addPngFromFile($file, $x, $y, $w =  0, $h =  0) {
	...
	// Assanka change: preventing E_DEPRECATED error
	// removed: set_magic_quotes_runtime(0);
    // End Assanka change
