...
if ($_POST["path"]) {
	...
	if ($_POST["overwritefile"]) $overwriteFile = true;
	else $overwriteFile = false;
	
	if ($_POST["percentwidth"] && !$_POST["pixelwidth"]) {
	...
	} else if ($_POST["pixelwidth"] && !$_POST["percentwidth"]) {
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="image.php" title="Screen Style" media="screen" />
</head>
