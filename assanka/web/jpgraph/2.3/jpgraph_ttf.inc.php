...
// Created: 	2006-11-19
// Ver:		$Id: jpgraph_ttf.inc.php,v 1.2 2008-05-29 17:57:22 robert Exp $
//
...
// IOMA fonts:
DEFINE("FF_THESANSPLAIN",54);
DEFINE("FF_THESANSLIGHTPLAIN",55);

// Limits for fonts
DEFINE("_FIRST_FONT",10);
DEFINE("_LAST_FONT",55);
	...
	$this->font_files=array(
	    ...
	    /* Misc fonts */
 	    ...
 	    FF_CALCULATOR => array(FS_NORMAL	=>'Triad_xs.ttf',  
				  ...
				  FS_ITALIC	=>'',   
				  FS_BOLDITALIC	=>'' ),   
 	    FF_THESANSPLAIN => array(FS_NORMAL=>'TheSansPlain.ttf',  
				  FS_BOLD	=>'',   
				  FS_ITALIC	=>'',   
				  FS_BOLDITALIC	=>'' ),   
 	    FF_THESANSLIGHTPLAIN => array(FS_NORMAL=>'TheSansLightPlain.ttf',  
				  FS_BOLD	=>'',   
				  FS_ITALIC	=>'',   
				  FS_BOLDITALIC	=>'' ),   
 	    );
