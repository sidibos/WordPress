...
// Assanka change: disable session_start which never appears to be used
//session_start();
...
// Assanka change: prefix set to nothing to stop aboslute linking!
/*------------------------------------------------------------------------------*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = "/lib/tmp/cmsfiles" ;
/*==============================================================================*/
...
//$fckphp_config['uploadProgressHandler']=$fckphp_config['prot'].$_SERVER['SERVER_NAME']."/lib/inc/uploadprogress/progress.cgi"; //Perl upload progress handler
/*==============================================================================*/
...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("zip","txt","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","swf","fla","flv","mov","ram","rv","ra","mp3","ppt","pps"),
	
	//Not implemented yet
	'AllowedMIME'		=>	array(),
	
	//Set the maximum single upload to this area to be unlimited
	'MaxSize'		=>	-1,
	
	//Set disk quota for this resource area to 500MB
	'DiskQuota'		=>	-1,
...
$fckphp_config['ResourceAreas']['Image'] =array(
	'AllowedExtensions'	=>	array("jpg","gif","jpeg","png","tiff","tif","bmp"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	-1,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
...
$fckphp_config['ResourceAreas']['Flash'] =array(
	'AllowedExtensions'	=>	array("swf","fla","flv"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	-1,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
...
$fckphp_config['ResourceAreas']['Media'] =array(
	'AllowedExtensions'	=>	array("swf","fla","flv","jpg","gif","jpeg","png","avi","mpg","mpeg","mov","ram","rv","ra","mp3","pdf","ppt","pps"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	-1,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
...
/*------------------------------------------------------------------------------*/
$fckphp_config['DiskQuota']['Global']=1000000000; //In MBytes (default: 50mb)
/*==============================================================================*/
...
/* $_GET */ $fckphp_config['Debug_GET']=true;
/* $_POST */ $fckphp_config['Debug_POST']=true;
/* $_SERVER */ $fckphp_config['Debug_SERVER']=true;
/* $_SESSIONS */ $fckphp_config['Debug_SESSIONS']=true;
